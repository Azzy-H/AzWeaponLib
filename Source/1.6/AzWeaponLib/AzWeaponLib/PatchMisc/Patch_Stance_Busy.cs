...
namespace AzWeaponLib
{
    ...
    public class Patch_Verb//Building
    {
        ...
        internal static bool NeedRetarget(LocalTargetInfo localTargetInfo)
        {
    ...
    public class Patch_Pawn_StanceTracker
    {
        ...
        //[HarmonyPatch("StanceTrackerTick")]
        //[HarmonyPostfix]
        //public static void Postfix_StanceTick(Pawn_StanceTracker __instance)
        //{
        //    Verb verb = __instance.pawn?.equipment?.PrimaryEq?.PrimaryVerb;
        //    if (verb != null && verb.verbProps is VerbProperties_ShootWithAmmo vpswa && vpswa.retargetRange > 0)
        //    {
        //        Log.Message("StanceTrackerTickPost" + RuntimeHelpers.GetHashCode(__instance.pawn.stances.curStance));
        //    }
        //}
    }
}
